...
import { captureLabSnapshot } from "./utils/exportSnapshot";
import "./App.css";
    ...
    <div className="app">
      <header className="app-header">
        ...
        <div className="app-actions">
          ...
          <button className="snapshot-btn" onClick={captureLabSnapshot} title="Save lab snapshot as PNG (Board + Scope)">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
